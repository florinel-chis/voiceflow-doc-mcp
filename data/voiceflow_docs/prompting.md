---
category: general
scraped_at: '2025-11-12T14:07:43.620455'
title: Prompting
url: /docs/prompting
---
...
Learn what prompting is, how to do it, and best practices for prompting when working with Large Language Models.

## What is a prompt?

A prompt is an input given to an LLM to guide its output. It's essentially a set of instructions or context that tells the model what kind of response you're looking for. Prompts can range from simple questions to complex scenarios with specific instructions.

Prompts are central to the concept of in-context learning, which is a key feature of LLMs. In-context learning refers to the model's ability to adapt to new tasks or generate specific outputs based solely on the information provided in the prompt, without needing to be retrained.

Using prompts, you can guide the LLM to perform a wide variety of tasks, such as:
...
Understanding the components of a prompt is crucial for effective interaction with LLMs. Let's break down the key elements that make up a prompt structure:

* **Prompt:** The input text given to an LLM, which the model uses as a starting point to generate a response or completion.
* **System Prompt:** A set of instructions or context provided to the LLM before the user's prompt, which helps guide the model's behavior and output.
* **Temperature:** A setting that controls the randomness of an LLM's output. Higher values result in more diverse and unpredictable responses, while lower values produce more focused and deterministic outputs.
...
[Crafting great prompts](/docs/crafting-great-prompts)[Components](/docs/components)

Ask AI

* [Table of Contents](#)
* + [What is a prompt?](#what-is-a-prompt)
  + [The Structure of a Prompt](#the-structure-of-a-prompt)

...
### [​](#option-1%3A-add-a-remote-http-server) Option 1: Add a remote HTTP server
...
### [​](#option-3%3A-add-a-local-stdio-server) Option 3: Add a local stdio server
...
### [​](#example%3A-connect-to-github-for-code-reviews) Example: Connect to GitHub for code reviews
...
### [​](#example%3A-query-your-postgresql-database) Example: Query your PostgreSQL database
...
[GitLab CI/CD](/docs/en/gitlab-ci-cd)[Migrate to Claude Agent SDK](/docs/en/sdk/migration-guide)

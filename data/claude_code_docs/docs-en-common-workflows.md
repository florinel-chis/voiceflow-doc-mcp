...
You can also run a query in Plan Mode directly with `-p` (i.e., in [“headless mode”](/docs/en/headless)):
...
For more details, see the [Slash commands](/docs/en/slash-commands) reference page.

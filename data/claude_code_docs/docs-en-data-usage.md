...
### [​](#feedback-using-the-%2Fbug-command) Feedback using the `/bug` command
...
![Claude Code data flow diagram](https://mintcdn.com/claude-code/-YhHHmtSxwr7W8gy/images/claude-code-data-flow.png?fit=max&auto=format&n=-YhHHmtSxwr7W8gy&q=85&s=4672f138596e864633b4b7c7ae4ae812)
...
[Security](/docs/en/security)[Monitoring](/docs/en/monitoring-usage)

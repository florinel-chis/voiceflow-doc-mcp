...
to run without approval using the `/permissions` command. See [Permissions docs](/docs/en/iam#configuring-permissions).
...
For additional JetBrains configuration tips, see our [IDE integration guide](/docs/en/vs-code#jetbrains-plugin-settings).
